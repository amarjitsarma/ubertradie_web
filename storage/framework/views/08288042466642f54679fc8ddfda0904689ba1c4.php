		...
		<div class="row">
			...
			<div class="col-md-12" style="overflow:scroll;">
				<table id="dataTable" class="table table-striped table-bordered table-responsive" width="100%">
					...
					<tr>
						<td><?php echo e($PersonalTrainer->BiometricCode); ?></td>
						...
						<td><?php echo e($PersonalTrainer->Trainer); ?></td>
						<td><?php echo e($PersonalTrainer->FromDate); ?></td>
						<td><?php echo e($PersonalTrainer->ToDate); ?></td>
					</tr>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</tbody>
				</table>
