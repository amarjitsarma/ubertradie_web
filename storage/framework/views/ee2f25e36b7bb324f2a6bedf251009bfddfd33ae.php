...
<section id="main-content">
    <section class="wrapper">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<a href="/SendBalance" class="btn btn-danger" onclick="return confirm('Are you sure?');">Send Bulk SMS about Balance</a>
			</div>
		</div>
		<div class="row">
			<h2>Expiry Detail</h2>
			...
			<div class="col-md-12">
				<a href="/SendExpiry" class="btn btn-danger" onclick="return confirm('Are you sure?');">Send Bulk SMS about Expiry</a>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<?php echo e(Form::open(array('url' =>'/GetStaffSalary',"class"=>"row", "method" => "GET"))); ?>
					...
					<div class="col-md-3">
						<div class="form-group">
							<select name="PlaceID" class="form-control" id="PlaceID" onchange="GetStaffs(); GetStudents();">
