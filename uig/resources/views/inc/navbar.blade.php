          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="/StudentAttendanceReport?FromDate={{date('Y-m-d')}}&ToDate={{date('Y-m-d')}}">Student Attendance</a></li>
                          <li><a  href="/StaffAttendanceReport?FromDate={{date('Y-m-d')}}&ToDate={{date('Y-m-d')}}">Staff Attendance</a></li>
