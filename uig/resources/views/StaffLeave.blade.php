...
<section id="main-content">
		  ...
		  @if(session()->has('message'))
			...
			@endif
			{{ Form::open(array('url' =>'/StaffLeave',"class"=>"row", "method" => "GET")) }}
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label>Staffs</label>
						<select name="StaffID" class="form-control" onchange="this.form.submit();">
				...
				<div class="col-md-4">
					<div class="form-group">
						<br/>
						<a href="/NewStaffLeave?StaffID={{$StaffID}}&PlaceID={{$PlaceID}}" class="btn btn-success">Add New Leave</a>
					</div>
				</div>
			  {{ Form::close() }}
