			...
			<?php endif; ?>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" name="StartDate" id="StartDate" class="form-control datepicker" value="<?php echo e($StartDate); ?>" onchange="GetPackageDetail();" required>
					</div>
				</div>	
				<div class="col-md-4">
					<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" name="ExpiryDate" id="ExpiryDate" class="form-control datepicker" value="<?php echo e($ExpiryDate); ?>" required readonly>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
